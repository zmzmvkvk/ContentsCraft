...
async function generateDetailStrategy({ title, memo, promptType }) {
  ...
  현재 영상 주제에 대해 도입–갈등–전개–전환–해결–콜투액션 구조를 따르는 숏츠영상 대본의 프레임을 만들어 주세요.
...
아래는 예시일뿐 형식만 참고하고 내용은 당신이 생각한 내용으로 JSON 형식으로 주세요.
{
  ...
  "st6": [
    { "idx": 1, "title": "5. 🌎 [대본 초안]" },
    { "idx": 2, "seq": "도입", "script": "이 알바생, 뭔가 이상하다...", "factor": ["클로즈업" + "슬로우모션", "관객반응", "미스터리한 분위기"], "target": "호기심 유발 / 리얼리티 콘텐츠 소비자"},
    { "idx": 3, "seq": "갈등", "script": "손님 중 한 명이 시비를 건다: "당구 좀 치냐?", "factor": ["긴장감 있는 BGM", "도발 자막", "셋업 암시"], "target": "..."},
    { "idx": 4, "seq": "전개", "script": "...", "factor": [...], "target": "..."},
    { "idx": 5, "seq": "전환", "script": "...", "factor": [...], "target": "..."},
    { "idx": 6, "seq": "해결", "script": "...", "factor": [...], "target": "..."},
  ]
}
`;
